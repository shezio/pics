...
def get_hebrew_date(date):  # pylint: disable=unused-variable redefined-outer-name missing-function-docstring
    res = requests.get(  # pylint: redefined-outer-name
...
def get_daily_mishna(date): # pylint: disable=unused-variable redefined-outer-name missing-function-docstring
...
with open("mishna_calendar_5785.html", "w", encoding="utf-8") as file:
    file.write(html)
